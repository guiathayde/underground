...
void LevelSewer::Initialize()
{
  ...
  Platform *basePlatform = new Platform(graphicManager, sf::Vector2f(5000.0f, 200.0f), sf::Vector2f(basePlatformPosition.x + 2500.0f, basePlatformPosition.y + 100.0f));
  Platform *limitBorderYLeft = new Platform(graphicManager, sf::Vector2f(5.0f, basePlatformPosition.y), sf::Vector2f(basePlatformPosition.x, basePlatformPosition.y / 2.0f));
  Platform *limitBorderYRight = new Platform(graphicManager, sf::Vector2f(5.0f, basePlatformPosition.y), sf::Vector2f(5000.0f, basePlatformPosition.y / 2.0f));
  ...
  */
  ...
  Platform *airPlatform3 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(840.0f, basePlatformPosition.y - 50.0f));
  Platform *airPlatform4 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(886.0f, basePlatformPosition.y - 50.0f));
  Platform *airPlatform5 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(932.0f, basePlatformPosition.y - 50.0f));
  Platform *airPlatform6 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(978.0f, basePlatformPosition.y - 50.0f));
  ...
  Platform *airPlatform7 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(2078.0f, basePlatformPosition.y - 150.0f));
  Platform *airPlatform8 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(2124.0f, basePlatformPosition.y - 150.0f));
  Platform *airPlatform9 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(2170.0f, basePlatformPosition.y - 150.0f));
  Platform *airPlatform10 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(2216.0f, basePlatformPosition.y - 150.0f));
  Platform *airPlatform11 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(2262.0f, basePlatformPosition.y - 150.0f));
  Platform *airPlatform12 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(2308.0f, basePlatformPosition.y - 150.0f));
  ...
  Platform *wallPlatform1 = new Platform(graphicManager, sf::Vector2f(16.0f, 46.0f), sf::Vector2f(2322.0f, basePlatformPosition.y - 180.0f));
  Platform *wallPlatform2 = new Platform(graphicManager, sf::Vector2f(16.0f, 46.0f), sf::Vector2f(2322.0f, basePlatformPosition.y - 226.0f));
  Platform *wallPlatform3 = new Platform(graphicManager, sf::Vector2f(16.0f, 46.0f), sf::Vector2f(2322.0f, basePlatformPosition.y - 270.0f));
  Platform *wallPlatform4 = new Platform(graphicManager, sf::Vector2f(16.0f, 46.0f), sf::Vector2f(2322.0f, basePlatformPosition.y - 316.0f));
  ...
  Platform *airPlatform13 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(2351.5f, basePlatformPosition.y - 332.0f));
  Platform *airPlatform14 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(2397.5f, basePlatformPosition.y - 332.0f));
  Platform *airPlatform15 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(2443.5f, basePlatformPosition.y - 332.0f));
  Platform *airPlatform16 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(2489.5f, basePlatformPosition.y - 332.0f));
  Platform *airPlatform17 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(2535.5f, basePlatformPosition.y - 332.0f));
  Platform *airPlatform18 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(2581.5f, basePlatformPosition.y - 332.0f));
  ...
  Platform *airPlatform19 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(3180.5f, basePlatformPosition.y - 30.0f));
  Platform *airPlatform20 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(3226.5f, basePlatformPosition.y - 30.0f));
  Platform *airPlatform21 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(3272.5f, basePlatformPosition.y - 30.0f));
  Platform *airPlatform22 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(3318.5f, basePlatformPosition.y - 30.0f));
  Platform *airPlatform23 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(3364.5f, basePlatformPosition.y - 30.0f));
  ...
  Platform *wallPlatform7 = new Platform(graphicManager, sf::Vector2f(16.0f, 46.0f), sf::Vector2f(4164.0f, basePlatformPosition.y - 115.0f));
  Platform *wallPlatform8 = new Platform(graphicManager, sf::Vector2f(16.0f, 46.0f), sf::Vector2f(4164.0f, basePlatformPosition.y - 161.0f));
  ...
  Platform *airPlatform24 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4195.5f, basePlatformPosition.y - 177.0f));
  Platform *airPlatform25 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4241.5f, basePlatformPosition.y - 177.0f));
  Platform *airPlatform26 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4287.5f, basePlatformPosition.y - 177.0f));
  Platform *airPlatform27 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4333.5f, basePlatformPosition.y - 177.0f));
  Platform *airPlatform28 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4379.5f, basePlatformPosition.y - 177.0f));
  ...
  Platform *wallPlatform9 = new Platform(graphicManager, sf::Vector2f(16.0f, 46.0f), sf::Vector2f(4394.0f, basePlatformPosition.y - 207.0f));
  Platform *wallPlatform10 = new Platform(graphicManager, sf::Vector2f(16.0f, 46.0f), sf::Vector2f(4394.0f, basePlatformPosition.y - 253.0f));
  Platform *wallPlatform11 = new Platform(graphicManager, sf::Vector2f(16.0f, 46.0f), sf::Vector2f(4394.0f, basePlatformPosition.y - 299.0f));
  Platform *wallPlatform12 = new Platform(graphicManager, sf::Vector2f(16.0f, 46.0f), sf::Vector2f(4394.0f, basePlatformPosition.y - 345.0f));
  ...
  Platform *airPlatform29 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4425.0f, basePlatformPosition.y - 361.0f));
  Platform *airPlatform30 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4471.0f, basePlatformPosition.y - 361.0f));
  Platform *airPlatform31 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4517.0f, basePlatformPosition.y - 361.0f));
  Platform *airPlatform32 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4563.0f, basePlatformPosition.y - 361.0f));
  Platform *airPlatform33 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4609.0f, basePlatformPosition.y - 361.0f));
  Platform *airPlatform34 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4655.0f, basePlatformPosition.y - 361.0f));
  Platform *airPlatform35 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4701.0f, basePlatformPosition.y - 361.0f));
  Platform *airPlatform36 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4747.0f, basePlatformPosition.y - 361.0f));
  Platform *airPlatform37 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4793.0f, basePlatformPosition.y - 361.0f));
  Platform *airPlatform38 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4839.0f, basePlatformPosition.y - 361.0f));
  Platform *airPlatform39 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4885.0f, basePlatformPosition.y - 361.0f));
  Platform *airPlatform40 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4931.0f, basePlatformPosition.y - 361.0f));
  Platform *airPlatform41 = new Platform(graphicManager, sf::Vector2f(46.0f, 14.0f), sf::Vector2f(4977.0f, basePlatformPosition.y - 361.0f));
